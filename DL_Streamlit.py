...
set_bg_hack('M:/vs code/py_programs/MP-2/background.jpg')

def load_model():
  model1=tf.keras.models.load_model('M:/vs code/py_programs/MP-2/vgg16')
  model2=tf.keras.models.load_model('M:/vs code/py_programs/MP-2/resnet50')
